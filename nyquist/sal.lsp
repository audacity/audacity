...
(setf *sneedacity-top-level-return-flag* nil)

;; SAL-COMPILE-SNEEDACITY -- special treatment of RETURN
;;
;; This works like SAL-COMPILE, but if there is a top-level
;; return statement (not normally legal), it is compiled into
;; a function named MAIN. This is a shorthand for Sneedacity plug-ins
;;
(defun sal-compile-sneedacity (input eval-flag multiple-statements filename)
  (progv '(*sneedacity-top-level-return-flag*) '(t)
