...
option(BUILD_VST3_TEST_PLUGIN "Build the test VST3 plugin and its controller (tools/vst3-test-plugin)" OFF)
...
message(STATUS "BUILD_VST3_TEST_PLUGIN=${BUILD_VST3_TEST_PLUGIN}")
...
macro(do_build build_type build_dir)
    ...
    set(CONFIGURE_ARGS -GNinja
        ...
        -DAU_BUILD_VST3_TEST_PLUGIN=${BUILD_VST3_TEST_PLUGIN}
    )
