...
set(RTAUDIO_API_JACK     OFF CACHE BOOL "")
set(RTAUDIO_API_PULSE    OFF CACHE BOOL "")
set(RTAUDIO_API_OSS      OFF CACHE BOOL "")
set(RTAUDIO_API_ASIO     OFF CACHE BOOL "")
set(RTAUDIO_API_DS       OFF CACHE BOOL "")
...
if (OS_IS_MAC)
    set(RTAUDIO_API_CORE  ON  CACHE BOOL "")
elseif (OS_IS_WIN)
    set(RTAUDIO_API_WASAPI ON CACHE BOOL "")
