...
if(BUILD_MODE MATCHES "DEV")
    set(AU4_UNSTABLE ON)
    set(AU4_RELEASE_CHANNEL "dev")
    set(AU4_NAME_VERSION "${AU4_NAME} ${AU4_VERSION_MAJOR} ${AU4_RELEASE_CHANNEL}")
    set(AU4_IS_PRERELEASE ON)
    set(AU4_ALLOW_UPDATE_ON_PRERELEASE OFF)
endif()

if(BUILD_MODE MATCHES "TESTING")
    set(AU4_UNSTABLE OFF)
    set(AU4_RELEASE_CHANNEL "Testing")
    set(AU4_NAME_VERSION "${AU4_NAME} ${AU4_VERSION_MAJOR} ${AU4_RELEASE_CHANNEL}")
    set(AU4_IS_PRERELEASE ON)
...
if(BUILD_MODE MATCHES "RELEASE")
    set(AU4_UNSTABLE OFF)
    set(AU4_NAME_VERSION "${AU4_NAME} ${AU4_VERSION_MAJOR}")
    set(AU4_IS_PRERELEASE OFF)
    set(AU4_ALLOW_UPDATE_ON_PRERELEASE OFF)
endif()
...
elseif (OS_IS_WIN)
    ...
    SET(AU4_INSTALL_NAME  "audacity${AU4_INSTALL_SUFFIX}-${AU4_VERSION_MAJ_MIN}/")
...
# Configure framework
###########################################
set(MUSE_APP_NAME ${AU4_NAME})
set(MUSE_APP_UNSTABLE ${AU4_UNSTABLE})
set(MUSE_APP_REVISION ${AU4_REVISION})
set(MUSE_APP_BUILD_NUMBER ${CMAKE_BUILD_NUMBER})
set(MUSE_APP_VERSION ${AU4_VERSION})
set(MUSE_APP_VERSION_LABEL "\"${AU4_VERSION_LABEL}\"")
set(MUSE_APP_INSTALL_SUFFIX "\"${AU4_INSTALL_SUFFIX}\"")
