...
# Uses MUSE_APP_VERSION_* variables from version.cmake
set( AUDACITY_VERSION_DEFS
    -DAUDACITY_VERSION=${MUSE_APP_VERSION_MAJOR}
    -DAUDACITY_RELEASE=${MUSE_APP_VERSION_MINOR}
    ...
    -DAUDACITY_FILE_VERSION=L"${MUSE_APP_VERSION_MAJOR},${MUSE_APP_VERSION_MINOR},${MUSE_APP_VERSION_PATCH},${AUDACITY_MODLEVEL}"
)
...
elseif(OS_IS_MAC)
    set(WXPLATFORM_DEFS -D__WXMAC__ -D__WXOSX__ -D__WXOSX_COCOA__)
elseif(OS_IS_WIN)
