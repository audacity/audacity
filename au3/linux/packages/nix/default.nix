...
stdenv.mkDerivation {
  ...
  postPatch = ''
    # Skip the SetupDevEnvironment step that tries to download dev tools, we are only interested in building
  ...
  cmakeFlags = [
    ...
    # This doesn't seem to be used anymore, but Arch and Fedora builds also set it. Leaving for consistency.
