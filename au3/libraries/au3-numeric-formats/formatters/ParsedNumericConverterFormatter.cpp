...
static BuiltinFormatString TimeConverterFormats_[] =  {
    {
        ...
        /*: Format string for displaying time in seconds. Change the comma
         * in the middle to the 1000s separator for your locale, and the 'seconds'
         * on the end to the word for seconds. Don't change the numbers. */
        TranslatableString("numeric-formats", "01000,01000 seconds")
    },

    {
        /*: Name of time display format that shows time in seconds
         * and milliseconds (1/1000 second) */
        { TranslatableString("numeric-formats", "seconds + milliseconds") },
        /*: Format string for displaying time in seconds and milliseconds
        ...
        { TranslatableString("numeric-formats", "01000,01000>01000 seconds"),
          TranslatableString("numeric-formats", "milliseconds") }
    },

    {
        NumericConverterFormats::HoursMinsSecondsFormat(),
        /*: Format string for displaying time in hours, minutes and
         * seconds. Change the 'h' to the abbreviation for hours, 'm' to the
         * abbreviation for minutes and 's' to the abbreviation for seconds. Don't
         * change the numbers unless there aren't 60 seconds in a minute in your
         * locale */
        TranslatableString("numeric-formats", "0100 h 060 m 060 s")
    },

    {
        /*: Name of time display format that shows time in days, hours,
         * minutes and seconds */
        { TranslatableString("numeric-formats", "dd:hh:mm:ss") },
        /*: Format string for displaying time in days, hours, minutes and
         * seconds. Change the 'days' to the word for days, 'h' to the abbreviation
         * for hours, 'm' to the abbreviation for minutes and 's' to the
         * abbreviation for seconds. Don't change the numbers unless there aren't
         * 24 hours in a day in your locale */
        TranslatableString("numeric-formats", "0100 days 024 h 060 m 060 s")
    },

    {
        NumericConverterFormats::HundredthsFormat(),
        /*: Format string for displaying time in hours, minutes, seconds
        ...
        { TranslatableString("numeric-formats", "0100 h 060 m 060>0100 s"),
          TranslatableString("numeric-formats", "centiseconds") }
    },

    {
         ...
         * The decimal separator is specified using '<' if your language uses a ',' or
         * to '>' if your language uses a '.'. */
        { TranslatableString("numeric-formats", "0100 h 060 m 060>01000 s"),
          TranslatableString("numeric-formats", "milliseconds") }
    },

    {
         ...
         * The decimal separator is specified using '<' if your language uses a ',' or
         * to '>' if your language uses a '.'. */
        TranslatableString("numeric-formats", "0100 h 060 m 060 s+># samples")
    },

    {
        /*: Name of time display format that shows time in samples (at the
         * current project sample rate).  For example the number of a sample at 1
         * second into a recording at 44.1KHz would be 44,100.
         */
        { TranslatableString("numeric-formats", "samples") },
        /*: Format string for displaying time in samples (lots of samples).
         * Change the ',' to the 1000s separator for your locale, and translate
         * samples. If 1000s aren't a base multiple for your number system, then you
         * can change the numbers to an appropriate one, and put a 0 on the front */
        TranslatableString("numeric-formats", "01000,01000,01000 samples|#")
    },

    {
        /*: Name of time display format that shows time in hours, minutes,
         * seconds and frames at 24 frames per second (commonly used for films) */
        { TranslatableString("numeric-formats", "hh:mm:ss + film frames (24 fps)") },
        /*: Format string for displaying time in hours, minutes, seconds
         ...
         * The decimal separator is specified using '<' if your language uses a ',' or
         * to '>' if your language uses a '.'. */
        TranslatableString("numeric-formats", "0100 h 060 m 060 s+>24 frames")
    },

    {
        /*: Name of time display format that shows time in frames (lots of
         * frames) at 24 frames per second (commonly used for films) */
        { TranslatableString("numeric-formats", "film frames (24 fps)") },
        /*: Format string for displaying time in frames at 24 frames per
         * second. Change the comma
         * in the middle to the 1000s separator for your locale,
         * translate 'frames' and leave the rest alone */
        TranslatableString("numeric-formats", "01000,01000 frames|24")
    },

    {
        ...
        { TranslatableString("numeric-formats", "hh:mm:ss + NTSC drop frames") },
        /*: Format string for displaying time in hours, minutes, seconds
         ...
         * The decimal separator is specified using '<' if your language uses a ',' or
         * to '>' if your language uses a '.'. */
        TranslatableString("numeric-formats", "0100 h 060 m 060 s+>30 frames|N")
    },

    {
        ...
        { TranslatableString("numeric-formats", "hh:mm:ss + NTSC non-drop frames") },
        /*: Format string for displaying time in hours, minutes, seconds
         * and frames with NTSC drop frames. Change the 'h' to the abbreviation
         * for hours, 'm' to the abbreviation for minutes, 's' to the abbreviation
         ...
         * The decimal separator is specified using '<' if your language uses a ',' or
         * to '>' if your language uses a '.'. */
        TranslatableString("numeric-formats", "0100 h 060 m 060 s+>030 frames| .999000999")
    },

    {
        /*: Name of time display format that shows time in frames at NTSC
         * TV frame rate (used for American / Japanese TV */
        { TranslatableString("numeric-formats", "NTSC frames") },
        /*: Format string for displaying time in frames with NTSC frames.
         * Change the comma
         * in the middle to the 1000s separator for your locale,
         * translate 'frames' and leave the rest alone. That really is the frame
         * rate! */
        TranslatableString("numeric-formats", "01000,01000 frames|29.97002997")
    },

    {
        /*: Name of time display format that shows time in hours, minutes,
         * seconds and frames at PAL TV frame rate (used for European TV) */
        { TranslatableString("numeric-formats", "hh:mm:ss + PAL frames (25 fps)") },
        /*: Format string for displaying time in hours, minutes, seconds
         ...
         * The decimal separator is specified using '<' if your language uses a ',' or
         * to '>' if your language uses a '.'. */
        TranslatableString("numeric-formats", "0100 h 060 m 060 s+>25 frames")
    },

    {
        /*: Name of time display format that shows time in frames at PAL
         * TV frame rate (used for European TV) */
        { TranslatableString("numeric-formats", "PAL frames (25 fps)") },
        /*: Format string for displaying time in frames with NTSC frames.
         * Change the comma
         * in the middle to the 1000s separator for your locale,
         * translate 'frames' and leave the rest alone. */
        TranslatableString("numeric-formats", "01000,01000 frames|25")
    },

    {
        /*: Name of time display format that shows time in hours, minutes,
         * seconds and frames at CD Audio frame rate (75 frames per second) */
        { TranslatableString("numeric-formats", "hh:mm:ss + CDDA frames (75 fps)") },
        /*: Format string for displaying time in hours, minutes, seconds
         ...
         * The decimal separator is specified using '<' if your language uses a ',' or
         * to '>' if your language uses a '.'. */
        TranslatableString("numeric-formats", "0100 h 060 m 060 s+>75 frames")
    },

    {
        /*: Name of time display format that shows time in frames at CD
         * Audio frame rate (75 frames per second) */
        { TranslatableString("numeric-formats", "CDDA frames (75 fps)") },
        /*: Format string for displaying time in frames with CD Audio
         * frames. Change the comma
         * in the middle to the 1000s separator for your locale,
         * translate 'frames' and leave the rest alone */
        TranslatableString("numeric-formats", "01000,01000 frames|75")
    },
};
...
static const BuiltinFormatString FrequencyConverterFormats_[] = {
    {
        ...
        {
            /*: Format string for displaying frequency in hertz. Change
            * the decimal point for your locale. Don't change the numbers.
            * The decimal separator is specified using '<' if your language uses a ',' or
            * to '>' if your language uses a '.'. */
            TranslatableString("numeric-formats", "010,01000>0100 Hz"),
            TranslatableString("numeric-formats", "centihertz")
        }
    },

    {
        /*: Name of display format that shows frequency in kilohertz */
        { TranslatableString("numeric-formats", "kHz") },
        {
            /*: Format string for displaying frequency in kilohertz. Change
            * the decimal point for your locale. Don't change the numbers.
            * The decimal separator is specified using '<' if your language uses a ',' or
            * to '>' if your language uses a '.'. */
            TranslatableString("numeric-formats", "01000>01000 kHz|0.001"),
            TranslatableString("numeric-formats", "hertz")
        }
    },
};
...
static const BuiltinFormatString BandwidthConverterFormats_[] = {
    {
        ...
        {
            /*: Format string for displaying log of frequency in octaves.
             * Change the decimal points for your locale. Don't change the numbers.
             * The decimal separator is specified using '<' if your language uses a ',' or
             * to '>' if your language uses a '.'. */
            TranslatableString("numeric-formats", "100>01000 octaves|1.442695041"), // Scale factor is 1 / ln (2)
            /*: an octave is a doubling of frequency */
            TranslatableString("numeric-formats", "thousandths of octaves")
        }
    },

    {
        ...
        { TranslatableString("numeric-formats", "semitones + cents") },
        {
            /*: Format string for displaying log of frequency in semitones
             * and cents.
             * Change the decimal points for your locale. Don't change the numbers.
             * The decimal separator is specified using '<' if your language uses a ',' or
             * to '>' if your language uses a '.'. */
            TranslatableString("numeric-formats", "1000 semitones >0100 cents|17.312340491"), // Scale factor is 12 / ln (2)
            /*: a cent is a hundredth of a semitone (which is 1/12 octave) */
            TranslatableString("numeric-formats", "hundredths of cents")
        }
    },

    {
        /*: Name of display format that shows log of frequency
         * in decades */
        { TranslatableString("numeric-formats", "decades") },
        {
            /*: Format string for displaying log of frequency in decades.
             * Change the decimal points for your locale. Don't change the numbers. */
            TranslatableString("numeric-formats", "10>01000 decades|0.434294482"), // Scale factor is 1 / ln (10)
            /*: a decade is a tenfold increase of frequency */
            TranslatableString("numeric-formats", "thousandths of decades")
        }
    },
};
...
public:
        ...
        , mFormat{std::move(format)}
    {
        ...
        mDependsOnSampleRate = mFormat.debugStr().contains(QLatin1Char('#'));
    }
