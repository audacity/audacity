...
class CLOUD_AUDIOCOM_API TaskExecutionService final : public Observer::Publisher<AppTaskReceivedMessage>
{
public:
    ...
    void SendResult(
        const std::string& taskId, sync::TaskStatus status, const std::string& errorMessage);
