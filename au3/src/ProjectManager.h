...
class AUDACITY_DLL_API ProjectManager final : public wxEvtHandler, public ClientData::Base
{
public:
    ...
    static AudacityProject* OpenProject(
        AudacityProject* pGivenProject, const FilePath& fileNameArg, bool addtohistory, bool reuseNonemptyProject);
