...
BaseSection {
    ...
    IncrementalPropertyControlWithTitle {
        ...
        currentValue: playbackModel.shortSkip
        ...
        onValueEdited: function(newValue) {
            playbackModel.shortSkipSelected(newValue)
        }
    }
    ...
    IncrementalPropertyControlWithTitle {
        ...
        currentValue: playbackModel.longSkip
        ...
        onValueEdited: function(newValue) {
            playbackModel.longSkipSelected(newValue)
        }
    }
}
