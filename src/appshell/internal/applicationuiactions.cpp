...
const UiActionList ApplicationUiActions::m_actions = {
    ...
    UiAction("restart", au::context::UiCtxAny, au::context::CTX_ANY, TranslatableString("action", "Restart")),
    UiAction(
        FULL_SCREEN_CODE,
        au::context::UiCtxAny,
        au::context::CTX_ANY,
    ...
    UiAction("about-musescore", au::context::UiCtxAny, au::context::CTX_ANY, TranslatableString("action", "&About MuseScore…")),
    UiAction("about-qt", au::context::UiCtxAny, au::context::CTX_ANY, TranslatableString("action", "About &Qt…")),
    UiAction("about-musicxml", au::context::UiCtxAny, au::context::CTX_ANY, TranslatableString("action", "About &MusicXML…")),
    UiAction(
        "online-handbook",
        au::context::UiCtxAny,
        au::context::CTX_ANY,
    ...
    UiAction("ask-help", au::context::UiCtxAny, au::context::CTX_ANY, TranslatableString("action", "As&k for help")),
    UiAction(
        "revert-factory",
        au::context::UiCtxAny,
        au::context::CTX_ANY,
...
ApplicationUiActions::ApplicationUiActions(std::shared_ptr<ApplicationActionController> controller) : m_controller(controller)
{
}
