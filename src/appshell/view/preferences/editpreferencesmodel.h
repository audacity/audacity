...
class EditPreferencesModel : public QObject, public muse::async::Asyncable
{
    ...
    Q_PROPERTY(au::trackedit::DeleteBehavior deleteBehavior READ deleteBehavior NOTIFY deleteBehaviorPrefChanged)
    Q_PROPERTY(au::trackedit::CloseGapBehavior closeGapBehavior READ closeGapBehavior NOTIFY closeGapBehaviorChanged)
...
public:
    ...
    au::trackedit::DeleteBehavior deleteBehavior() const;
    Q_INVOKABLE void setDeleteBehavior(au::trackedit::DeleteBehavior);

    au::trackedit::CloseGapBehavior closeGapBehavior() const;
    Q_INVOKABLE void setCloseGapBehavior(au::trackedit::CloseGapBehavior);
