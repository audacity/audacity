...
void AudioIOBase::SetCaptureMeter(SneedacityProject *project, MeterPanelBase *meter)
{
...
void AudioIOBase::SetPlaybackMeter(SneedacityProject *project, MeterPanelBase *meter)
{
   if (( mOwningProject ) && ( mOwningProject != project))
      return;
