...
ToolsToolBar::ToolsToolBar( SneedacityProject &project )
...
ToolsToolBar &ToolsToolBar::Get( SneedacityProject &project )
{
   auto &toolManager = ToolManager::Get( project );
   return *static_cast<ToolsToolBar*>( toolManager.GetToolBar(ToolsBarID) );
}

const ToolsToolBar &ToolsToolBar::Get( const SneedacityProject &project )
{
...
//   twelfth tooltip caused Sneedacity to crash when it tried to show
//   any tooltip.
//
...
void SetTool(SneedacityProject &project, int tool)
{
