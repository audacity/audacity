...
static UiActionList STATIC_ACTIONS = {
    ...
    UiAction("action://projectscene/global-view-spectrogram",
             au::context::UiCtxProjectOpened,
             au::context::CTX_PROJECT_FOCUSED,
    ...
    UiAction("action://projectscene/track-view-waveform",
             au::context::UiCtxAny,
             au::context::CTX_ANY,
    ...
    UiAction("action://projectscene/track-view-spectrogram",
             au::context::UiCtxAny,
             au::context::CTX_ANY,
    ...
    UiAction("action://projectscene/track-view-multi",
             au::context::UiCtxAny,
             au::context::CTX_ANY,
...
const ToolConfig& ProjectSceneUiActions::defaultPlaybackToolBarConfig()
{
    ...
    if (!config.isValid()) {
        config.items = {
            ...
            { "clip-gain", true },
            { "split-tool", true },
            { "action://projectscene/global-view-spectrogram", true },
            { "zoom-in", true },
            { "zoom-out", true },
