...
Rectangle {
    ...
    NavigationControl {
        ...
        accessible.name: qsTrc("accessibility", "Clip: %1").arg(root.title)
        ...
        Rectangle {
            ...
            StyledTextLabel {
                ...
                NavigationControl {
                    ...
                    accessible.name: qsTrc("accessibility", "Clip name: %1").arg(root.title)
            ...
            Row {
                ...
                MenuButton {
                    ...
                    navigation.column: 4
                    navigation.accessible.name: qsTrc("accessibility", "Clip menu")
