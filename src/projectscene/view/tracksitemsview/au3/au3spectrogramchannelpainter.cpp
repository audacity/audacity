...
// AColor::colorSchemes                                 just a constant int
// AColor::ColorGradientEdge                            just an ColorGradientChoice enum value
// AColor::ColorGradientTimeAndFrequencySelected        just an ColorGradientChoice enum value
// AColor::ColorGradientTimeSelected            just an ColorGradientChoice enum value
// AColor::gradient_inited                          just a bool
// AColor::PreComputeGradient
// AColor::ColorGradientChoice                       ColorGradientChoice enum
