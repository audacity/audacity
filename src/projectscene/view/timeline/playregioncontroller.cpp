...
void PlayRegionController::mouseMove(double pos)
{
    ...
    case Action::CreateRegion:
        ...
        m_action = Action::ResizeEnd;
        break;
    case Action::ResizeStart:
        setStartTime(pos);
        break;
    case Action::ResizeEnd:
        setEndTime(pos);
        break;
    case Action::Drag: {
...
void PlayRegionController::mouseUp(double pos)
{
    ...
    if (m_action == Action::Drag && !m_dragStarted) {
