...
CloudErrorDialogInfo getCloudErrorDialogInfo(int code)
{
    ...
    case Err::ProjectLimitReached:
        return { muse::trc("cloud", PRJ_LIMIT_REACHED_TITLE), muse::trc("cloud", PRJ_LIMIT_REACHED_TEXT) };
    case Err::ProjectStorageLimitReached:
        return { muse::trc("cloud", PRJ_SIZE_EXCEEDED_TITLE), muse::trc("cloud", PRJ_SIZE_EXCEEDED_TEXT) };
    case Err::ProjectNotFound:
        return { muse::trc("cloud", CLOUD_SAVE_UNAVAILABLE_TITLE), muse::trc("cloud", CLOUD_SAVE_UNAVAILABLE_TEXT) };
    ...
    case Err::SnapshotFailed:
        return { muse::trc("cloud", DEFAULT_SYNC_ERROR_TITLE), muse::trc("cloud", DEFAULT_SYNC_ERROR_TEXT) };
    default:
        return { muse::trc("cloud", DEFAULT_CLOUD_ERROR_TITLE), muse::trc("cloud", DEFAULT_CLOUD_ERROR_TEXT) };
    }
}
}
