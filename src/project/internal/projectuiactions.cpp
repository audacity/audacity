...
const UiActionList ProjectUiActions::m_actions = {
    ...
    UiAction("log", au::context::UiCtxAny, au::context::CTX_ANY, TranslatableString("action", "Log"), TranslatableString("action", "Log")),
    UiAction(
        "crash-report",
        au::context::UiCtxAny,
        au::context::CTX_ANY,
...
ProjectUiActions::ProjectUiActions(std::shared_ptr<ProjectActionsController> controller) : m_controller(controller)
{
}
