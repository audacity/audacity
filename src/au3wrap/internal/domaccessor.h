...
public:
    ...
    static std::shared_ptr<WaveClip> findWaveClip(Au3WaveTrack* track, uint64_t au3ClipId);
    static std::shared_ptr<WaveClip> findWaveClip(Au3Project& prj, const Au3TrackId& au3trackId, size_t index);
    ...
    static std::list<std::shared_ptr<WaveClip> > waveClipsAsList(Au3WaveTrack* track);
};
}
