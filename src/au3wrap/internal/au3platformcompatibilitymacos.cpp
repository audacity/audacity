...
std::string PlatformCompatibility::GetDataDir()
{
    ...
    if (_NSGetExecutablePath(path, &size) == 0) {
        ...
        return executablePath.substr(0, executablePath.find_last_of("/")) + "/Contents/SharedSupport";
    }
    return "";
}
...
std::string PlatformCompatibility::GetPluginsDir()
{
    ...
    if (_NSGetExecutablePath(path, &size) == 0) {
        ...
        return executablePath.substr(0, executablePath.find_last_of("/")) + "/Contents/Plugins";
    }
    return "";
}
...
std::string PlatformCompatibility::GetResourcesDir()
{
    ...
    if (_NSGetExecutablePath(path, &size) == 0) {
        ...
        return executablePath.substr(0, executablePath.find_last_of("/")) + "/Contents/Resources";
    }
    return "";
}
