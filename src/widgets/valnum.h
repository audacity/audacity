...
class SNEEDACITY_DLL_API NumValidatorBase /* not final */ : public wxValidator
{
public:
...
class SNEEDACITY_DLL_API IntegerValidatorBase /* not final */
...
class SNEEDACITY_DLL_API FloatingPointValidatorBase /* not final */
   : public NumValidatorBase
{
public:
...
SNEEDACITY_DLL_API double RoundValue(int precision, double value);
