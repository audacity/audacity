...
) const
{
   ...
   if (units < .025 * (60 / mBpm) * (4 / (double)mTimeSigLower))
   {
      // measures
   ...
   else if (units < .05 * (60 / mBpm) * (4 / (double)mTimeSigLower))
   {
      // measures
      major = (60 * mTimeSigUpper) / (mBpm * ((double)mTimeSigLower / 4));
   ...
   else if (units < .1 * (60 / mBpm) * (4 / (double)mTimeSigLower))
   {
      // measures
      major = (60 * mTimeSigUpper) / (mBpm * ((double)mTimeSigLower / 4));
   ...
   else if (units < .4 * (60 / mBpm) * (4 / (double)mTimeSigLower))
   {
      // measures
      major = (60 * mTimeSigUpper) / (mBpm * ((double)mTimeSigLower / 4));
      // eigth notes (label every quarter note)
...
) const
{
   ...
   if (units < .4 * (60 / mBpm)* (4 / (double)mTimeSigLower))
   {
