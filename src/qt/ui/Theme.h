...
namespace audacity
{
   ...
   class Theme : public QObject
   {
      ...
      Q_PROPERTY(QColor backgroundColor1 MEMBER mBackgroundColor1 NOTIFY backgroundColor1Changed FINAL)
      Q_PROPERTY(QColor backgroundColor2 MEMBER mBackgroundColor2 NOTIFY backgroundColor2Changed FINAL)
      Q_PROPERTY(QColor backgroundColor3 MEMBER mBackgroundColor3 NOTIFY backgroundColor3Changed FINAL)
      Q_PROPERTY(QColor backgroundColor4 MEMBER mBackgroundColor4 NOTIFY backgroundColor4Changed FINAL)
      Q_PROPERTY(QColor fontColor1 MEMBER mFontColor1 NOTIFY fontColor1Changed FINAL)
      Q_PROPERTY(QColor fontColor2 MEMBER mFontColor2 NOTIFY fontColor2Changed FINAL)
      Q_PROPERTY(QColor buttonColor MEMBER mButtonColor NOTIFY buttonColorChanged FINAL)
      Q_PROPERTY(QColor brandColor MEMBER mBrandColor NOTIFY brandColorChanged FINAL)
      Q_PROPERTY(QColor textFieldColor MEMBER mTextFieldColor NOTIFY textFieldColorChanged FINAL)
      ...
      Q_PROPERTY(QColor strokeColor1 MEMBER mStrokeColor1 NOTIFY strokeColor1Changed FINAL)
      Q_PROPERTY(QColor strokeColor2 MEMBER mStrokeColor2 NOTIFY strokeColor2Changed FINAL)
      Q_PROPERTY(QColor strokeColor3 MEMBER mStrokeColor3 NOTIFY strokeColor3Changed FINAL)
   ...
   public:
      ...
      void setBackgroundColor3(QColor color);
      void setBackgroundColor4(QColor color);
