...
QVariant AdvancedPreferencesModel::data(const QModelIndex& index, int role) const
{
    ...
    const muse::Settings::Item& item = m_items.at(index.row());
    switch (role) {
...
void AdvancedPreferencesModel::load()
{
    ...
    muse::Settings::Items items = muse::settings()->items();
...
{
    muse::Settings::Item& item = m_items[index];
    muse::Val::Type type = item.value.type();
    item.value = muse::Val::fromQVariant(newVal);
    item.value.setType(type);

    muse::settings()->setSharedValue(item.key, item.value);
}
...
QString AdvancedPreferencesModel::typeToString(muse::Val::Type type) const
{
    switch (type) {
    case muse::Val::Type::Undefined: return "Undefined";
    case muse::Val::Type::Bool: return "Bool";
    case muse::Val::Type::Int: return "Int";
    case muse::Val::Type::Int64: return "Int";
    case muse::Val::Type::Double: return "Double";
    case muse::Val::Type::String: return "String";
    case muse::Val::Type::Color: return "Color";
    case muse::Val::Type::List: return "List";
    case muse::Val::Type::Map: return "Map";
    }
    return "Undefined";
}
