...
{
public:
    Au3AudioIOListener() : m_timer(std::chrono::milliseconds(100))
    {
    ...
    muse::async::Notification updateRequested() const
    {
        return m_updateRequested;
    }
    muse::async::Notification commitRequested() const
    {
        return m_commitRequested;
    }
    muse::async::Notification finished() const
    {
        return m_finished;
    }
