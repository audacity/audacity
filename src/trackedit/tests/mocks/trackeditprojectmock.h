...
public:
    ...
    MOCK_METHOD(ItemTimeSpanList, itemTimeSpansSorted, (const TrackId& trackId), (const, override));
    MOCK_METHOD(std::optional<TimeSpan>, itemTimeSpan, (const TrackItemKey& key), (const, override));
