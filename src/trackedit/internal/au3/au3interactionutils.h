...
void exchangeContent(au3::Au3TrackList& tracks, au3::Au3WaveTrack& oldOne, au3::Au3WaveTrack& newOne);
...
ClipConversionType moveClipsUpOrDown(int offset, const au3::Au3TrackList& orig, au3::Au3TrackList& copy,
