...
void TrackeditActionsController::init()
{
    ...
    dispatcher()->reg(this, OPEN_CLIP_AND_SPEED_CODE, this, &TrackeditActionsController::globalOpenClipPitchAndSpeed);
...
void TrackeditActionsController::globalOpenClipPitchAndSpeed()
{
    auto selectedClips = selectionController()->selectedClips();
