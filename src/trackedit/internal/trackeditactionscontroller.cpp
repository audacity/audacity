...
void TrackeditActionsController::init()
{
    ...
    dispatcher()->reg(this, SPLIT_DELETE_CODE, withPlaybackStop(&TrackeditActionsController::doGlobalSplitDelete));
    dispatcher()->reg(this, SPLIT_CODE, withPlaybackStop(&TrackeditActionsController::doGlobalSplit));
    dispatcher()->reg(this, JOIN_CODE, withPlaybackStop(&TrackeditActionsController::doGlobalJoin));
    ...
    dispatcher()->reg(this, TRACK_SPLIT, withPlaybackStop(&TrackeditActionsController::trackSplit));
    dispatcher()->reg(this, TRACK_SPLIT_AT, withPlaybackStop(&TrackeditActionsController::tracksSplitAt));
    dispatcher()->reg(this, MERGE_SELECTED_ON_TRACK, withPlaybackStop(&TrackeditActionsController::mergeSelectedOnTrack));
    dispatcher()->reg(this, UNDO, withPlaybackStop(&TrackeditActionsController::undo));
    dispatcher()->reg(this, REDO, withPlaybackStop(&TrackeditActionsController::redo));
    dispatcher()->reg(this, DUPLICATE_SELECTED, withPlaybackStop(&TrackeditActionsController::duplicateSelected));
    dispatcher()->reg(this, DUPLICATE_CLIP, withPlaybackStop(&TrackeditActionsController::duplicateClip));
    dispatcher()->reg(this, CLIP_SPLIT_CUT, withPlaybackStop(&TrackeditActionsController::clipSplitCut));
    ...
    dispatcher()->reg(this, STRETCH_ENABLED_CODE, withPlaybackStop(&TrackeditActionsController::toggleStretchClipToMatchTempo));
