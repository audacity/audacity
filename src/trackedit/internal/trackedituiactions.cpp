...
UiActionList STATIC_ACTIONS = {
    ...
    // TODO: the past action is handled at app level, when we enable this trackedit/paste-default action,
    // there will be two paste actions in the shortcut menu, until the framework supports contextual actions/shortcuts
    UiAction("action://trackedit/paste-default",
             au::context::UiCtxAny,
             au::context::CTX_ANY,
             TranslatableString("action", "&Paste (default)"),
