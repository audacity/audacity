...
#ifndef __SNEEDACITY_INTERPOLATE_AUDIO__
#define __SNEEDACITY_INTERPOLATE_AUDIO__
...
// the other.
void SNEEDACITY_DLL_API InterpolateAudio(float *buffer, size_t len,
                                       size_t firstBad, size_t numBad);

#endif // __SNEEDACITY_INTERPOLATE_AUDIO__
