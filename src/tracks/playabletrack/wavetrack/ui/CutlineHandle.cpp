...
void CutlineHandle::Enter(bool, SneedacityProject *)
{
...
(const TrackPanelMouseEvent &, SneedacityProject *pProject, wxWindow *)
{
...
UIHandle::Result CutlineHandle::Cancel(SneedacityProject *pProject)
{
   using namespace RefreshCode;
   UIHandle::Result result = RefreshCell;
   ProjectHistory::Get( *pProject ).RollbackState();
   if (mOperation == Expand) {
      SneedacityProject &project = *pProject;
