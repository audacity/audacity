...
(const wxMouseEvent &, SneedacityProject *pProject, wxWindow*)
{
...
TranslatableString MinimizeButtonHandle::Tip(
   const wxMouseState &, SneedacityProject &) const
{
...
(const wxMouseEvent &, SneedacityProject *pProject, wxWindow *WXUNUSED(pParent))
{
