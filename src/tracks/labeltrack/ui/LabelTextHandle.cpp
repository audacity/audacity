...
void LabelTextHandle::Enter(bool, SneedacityProject *)
{
...
void LabelTextHandle::HandleTextClick(SneedacityProject &
...
UIHandle::Result LabelTextHandle::Cancel( SneedacityProject *pProject )
{
