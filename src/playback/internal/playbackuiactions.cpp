...
PlaybackUiActions::PlaybackUiActions(std::shared_ptr<PlaybackController> controller) : m_controller(controller)
{
}
...
void PlaybackUiActions::init()
{
    ...
    m_controller->isPlayingChanged().onNotify(this, [this]() {
        ActionCodeList codes = {PLAY_ACTION_CODE, PAUSE_ACTION_CODE, REWIND_START_ACTION_CODE, REWIND_END_ACTION_CODE};
