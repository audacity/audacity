...
const UiActionList PlaybackUiActions::m_mainActions = {
    UiAction(PLAY_ACTION_CODE,
             ...
             TranslatableString("action", "Start playing audio"),
    ...
    UiAction(REWIND_START_ACTION_CODE,
             ...
             TranslatableString("action", "Bring the playhead to the start of the project"),
             IconCode::Code::REWIND_START_FILL
             ),
    UiAction(REWIND_END_ACTION_CODE,
             au::context::UiCtxProjectOpened,
             au::context::CTX_PROJECT_FOCUSED,
             TranslatableString("action", "Forward to end"),
             TranslatableString("action", "Bring the playhead to the end of the project"),
    ...
    UiAction(LOOP_ACTION_CODE,
             ...
             TranslatableString("action", "Repeat playback between loop points"),
             IconCode::Code::LOOP,
             Checkable::Yes
             ),
    ...
    UiAction("metronome",
             ...
             TranslatableString("action", "Plays a metronome sound while recording"),
    ...
    UiAction("playback-bpm",
             ...
             TranslatableString("action", "Set project tempo"),
             IconCode::Code::BPM
             ),
    UiAction("playback-time-signature",
             ...
             TranslatableString("action", "Set project time signature"),
...
const UiActionList PlaybackUiActions::m_loopBoundaryActions = {
    UiAction("loop-in",
             au::context::UiCtxAny,
             au::context::CTX_PROJECT_FOCUSED,
             TranslatableString("action", "Set loop in point"),
             TranslatableString("action", "Defines the left edge of the loop"),
             IconCode::Code::LOOP_IN
             ),
    UiAction("loop-out",
             au::context::UiCtxAny,
             au::context::CTX_PROJECT_FOCUSED,
             TranslatableString("action", "Set loop out point"),
             TranslatableString("action", "Defines the right edge of the loop"),
