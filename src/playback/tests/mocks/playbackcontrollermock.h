...
public:
    ...
    MOCK_METHOD(void, setAudioApi, (const std::string&), (override));
    MOCK_METHOD(void, setAudioOutputDevice, (const std::string&), (override));
    MOCK_METHOD(void, setAudioInputDevice, (const std::string&), (override));
    MOCK_METHOD(void, setInputChannels, (int), (override));
    MOCK_METHOD(void, setBufferLength, (double), (override));
    MOCK_METHOD(void, setLatencyCompensation, (double), (override));

    MOCK_METHOD(void, withSingleStreamRestart, (const std::function<void()>&), (override));
