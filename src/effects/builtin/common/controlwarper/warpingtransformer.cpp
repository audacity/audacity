...
WarpingTransformer::WarpingTransformer(ControlWarpingType warpingType)
    : m_C{warpingType == ControlWarpingType::Aggressive ? aggressiveC : softC}
    , m_expC{warpingType == ControlWarpingType::Aggressive ? aggressiveExpC : softExpC}
{}
