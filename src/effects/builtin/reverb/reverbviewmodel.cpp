...
void ReverbViewModel::doReload()
{
    ...
    m_paramsList << makeItem(
        ...
        [this](double v) {
            mutSettings<ReverbSettings>().mRoomSize = v;
        }
    );
    ...
    m_paramsList << makeItem(
        ...
        [this](double v) {
            mutSettings<ReverbSettings>().mPreDelay = v;
        }
    );
    ...
    m_paramsList << makeItem(
        ...
        [this](double v) {
            mutSettings<ReverbSettings>().mReverberance = v;
        }
    );
    ...
    m_paramsList << makeItem(
        ...
        [this](double v) {
            mutSettings<ReverbSettings>().mHfDamping = v;
        }
    );
    ...
    m_paramsList << makeItem(
        ...
        [this](double v) {
            mutSettings<ReverbSettings>().mToneLow = v;
        }
    );
    ...
    m_paramsList << makeItem(
        ...
        [this](double v) {
            mutSettings<ReverbSettings>().mToneHigh = v;
        }
    );
    ...
    m_paramsList << makeItem(
        ...
        [this](double v) {
            mutSettings<ReverbSettings>().mWetGain = v;
        }
    );
    ...
    m_paramsList << makeItem(
        ...
        [this](double v) {
            mutSettings<ReverbSettings>().mDryGain = v;
        }
    );
    ...
    m_paramsList << makeItem(
        ...
        [this](double v) {
            mutSettings<ReverbSettings>().mStereoWidth = v;
        }
    );
