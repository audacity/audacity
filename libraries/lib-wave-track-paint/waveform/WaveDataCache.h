...
class WAVE_TRACK_PAINT_API WaveDataCache final :
...
public:
   ...
   WaveDataCache(const WaveClip& waveClip);
   WaveDataCache(DataProvider provider, ElementFactory elementFactory, double sampleRate);
