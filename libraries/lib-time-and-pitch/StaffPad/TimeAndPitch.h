...
public:
  ...
  */
  ...
  /**
    Return the ~number of samples until the next hop gets processed (might be 1 or 2 too high)
    If this number of samples is added using feedAudio(), more output samples are produced.
    */
