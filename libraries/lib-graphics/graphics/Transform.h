...
public:
   ...
   static FullTransformType<DataType> Translation(DataType x, DataType y) noexcept
   {
      return FullTransformType<DataType>(
         DataType(1), DataType(0), x,
         DataType(0), DataType(1), y);
   }

   static FullTransformType<DataType> Translation(PointType<DataType> pt) noexcept
   {
   ...
   {
      return FullTransformType<DataType>(
         sx,          DataType(0), DataType(0),
         DataType(0), sy,          DataType(0));
   }
   ...
   static FullTransformType<DataType> Rotation(DataType angle)
   {
      ...
      return FullTransformType<DataType>(
         DataType(c), DataType(-s), DataType(0),
         DataType(s), DataType( c), DataType(0));
   }
   ...
   {
      const DataType lhsRow0[3] = { mMatrix[0][0], mMatrix[0][1], mMatrix[0][2] };
      const DataType lhsRow1[3] = { mMatrix[1][0], mMatrix[1][1], mMatrix[1][2] };

      const DataType rhsRow0[3] = { tr.mMatrix[0][0], tr.mMatrix[0][1], tr.mMatrix[0][2] };
      const DataType rhsRow1[3] = { tr.mMatrix[1][0], tr.mMatrix[1][1], tr.mMatrix[1][2] };
      ...
      mMatrix[0][2] = lhsRow0[0] * rhsRow0[2] + lhsRow0[1] * rhsRow1[2] + lhsRow0[2];
      mMatrix[1][2] = lhsRow1[0] * rhsRow0[2] + lhsRow1[1] * rhsRow1[2] + lhsRow1[2];
...
private:
   FullTransformType(DataType m00, DataType m01, DataType m02,
                     DataType m10, DataType m11, DataType m12) noexcept
